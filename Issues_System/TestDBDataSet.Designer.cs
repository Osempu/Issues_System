...
namespace Issues_System.TestDBDataSetTableAdapters {
...
SELECT Id, OpenBy, AssignedTo, Line, Equipment, openAt FROM Issues WHERE (Id = @Id)";
        ...
        public virtual int Fill(TestDBDataSet.IssuesDataTable dataTable) {
        ...
        public virtual TestDBDataSet.IssuesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            TestDBDataSet.IssuesDataTable dataTable = new TestDBDataSet.IssuesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(TestDBDataSet.IssuesDataTable dataTable) {
